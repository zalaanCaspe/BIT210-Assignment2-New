    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Shelter Home for Chlidren</h2>
          <ol>
    ...
    <section id="specific-organization" class="specific-organization section-bg">
      <div class="container">
        ...
        <div class="row specific-organization-info">
          <div class="col-lg-6">
            <img src="../assets/img/organizations/shelter-home-logo.jpg" class="img-fluid border" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Shelter Home for Children</h3>
            <ul>
              <li><strong>Organization ID:</strong> ORG007</li>
              <li><strong>Category:</strong> Social</li>
              <li><strong>Address:</strong><br>
                No. 9, 1st Floor, <br>
                Jalan Barat, Pjs 8, <br>
                46200 Petaling Jaya, <br>
                Selangor
              </li>
              <li><strong>Website:</strong> <a href="https://www.shelterhome.org/">https://www.shelterhome.org/</a></li>
              <br>
              <li>
                Shelter Home is an NGO that shelters children who have suffered from abuse,
                neglected or abandoned backgrounds and is supported mainly from the public.
                They value the importance in updating their supporters on their children's progress and milestones.
                <br>
                <small>From the <a href="https://www.shelterhome.org/">Shelter Home website</a></small>
              </li>
            </ul>
          </div>
        </div>
        ...
        <section class="row justify-content-center">
          ...
          <div class="col col-lg-8  list-of-reps">
            <table id="representatives" class="table sortable-table" data-table-for="Representative">
              ...
              <tbody>
                <tr>
                  <td><a href="../users/syed.hisam001.php">Tay Yeu Goo</a></td>
