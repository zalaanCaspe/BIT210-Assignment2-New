...
<head>
  ...
  <title>Project Wawasan Rakyat</title>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Project Wawasan Rakyat</h2>
          <ol>
            <li><a href="../index.php">Home</a></li>
            <li><a href="../organizations.php">Organizations</a></li>
            <li>Project Wawasan Rakyat</li>
          </ol>
        </div>
    ...
    <section id="specific-organization" class="specific-organization section-bg">
      <div class="container">
        ...
        <div class="row specific-organization-info">
          <div class="col-lg-6">
            <img src="../assets/img/organizations/project-wawasan-rakyat-logo.jpg" class="img-fluid border" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Project Wawasan Rakyat</h3>
            <ul>
              <li><strong>Organization ID:</strong> ORG005</li>
              <li><strong>Category:</strong> Social</li>
              <li><strong>Address:</strong> Kuala Lumpur
              </li>
              <li><strong>Website:</strong> <a
                  href="https://www.facebook.com/ProjekWawasanRakyat">https://www.facebook.com/ProjekWawasanRakyat</a>
              </li>
              <br>
              <li>
                Prokect Wawasan Rakyat (POWR) is a youth-based movement
                that strives for #Prinsip1st prioritization,
                #Decentralized democracy and #StrongerTogether unity
                <br>
                <small>From the <a href="ttps://www.facebook.com/ProjekWawasanRakyat">POWR Facebook page</a></small>
              </li>
            </ul>
          </div>
        </div>
        ...
        <section class="row justify-content-center">
          ...
          <div class="col col-lg-8  list-of-reps">
            <table id="representatives" class="table sortable-table" data-table-for="Representative">
              ...
              <tbody>
                <tr>
                  <td><a href="../users/syed.hisam001.php">Syahriman bin Che Haqimie Misnan</a></td>
