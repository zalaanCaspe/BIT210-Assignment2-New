...
<head>
  ...
  <title>Refuge for the Refugees</title>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Refuge for the Refugees</h2>
          <ol>
            <li><a href="../index.php">Home</a></li>
            <li><a href="../organizations.php">Organizations</a></li>
            <li>Refuge for the Refugees</li>
          </ol>
        </div>
    ...
    <section id="specific-organization" class="specific-organization section-bg">
      <div class="container">
        ...
        <div class="row specific-organization-info">
          <div class="col-lg-6">
            <img src="../assets/img/organizations/refuge-for-the-refugees-logo.jpg" class="img-fluid border" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Refuge for the Refugees</h3>
            <ul>
              <li><strong>Organization ID:</strong> ORG006</li>
              <li><strong>Category:</strong> Social</li>
              ...
              <li><strong>Website:</strong>
                <a href="https://rftr.super.site/">https://rftr.super.site/</a>,
                <a
                  href="https://www.facebook.com/refugefortherefugees/">https://www.facebook.com/refugefortherefugees/</a>
              </li>
              <br>
              <li>
                Refuge For The Refugees develops services and networks that empower refugees and
                advocate for their rights in Malaysia.
                Their work includes support for individuals, emergency relief and aid,
                education programs, case management, and policy development.
                They partner with businesses, public-sector agencies, other NGOs,
                and individuals who share our vision of giving those in the
                refugee community the voice and opportunities they deserve.
                <br>
                <small>From the <a href="https://www.facebook.com/refugefortherefugees/">Refuge for the Refugees
                    Facebook page</a></small>
              </li>
            </ul>
          </div>
        </div>
        ...
        <section class="row justify-content-center">
          ...
          <div class="col col-lg-8  list-of-reps">
            <table id="representatives" class="table sortable-table" data-table-for="Representative">
              ...
              <tbody>
                <tr>
                  <td><a href="../users/syed.hisam001.php">Daniel Ching Liek Keat</a></td>
