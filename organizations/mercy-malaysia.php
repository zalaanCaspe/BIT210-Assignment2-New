        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>MERCY Malaysia</h2>
                    <ol>
                        <li><a href="../index.php">Home</a></li>
                        <li><a href="../organizations.php">Organizations</a></li>
                        <li>MERCY Malaysia</li>
                    </ol>
                </div>
        ...
        <section id="specific-organization" class="specific-organization section-bg">
            <div class="container">
                ...
                <div class="row specific-organization-info">
                    <div class="col-lg-6">
                        <img src="../assets/img/organizations/mercy-malaysia-logo.jpg" class="img-fluid border" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <h3>MERCY Malaysia</h3>
                        <ul>
                            <li><strong>Organization ID:</strong> ORG002</li>
                            <li><strong>Category:</strong> Health</li>
                            <li><strong>Address:</strong><br>
                                Bangunan Mcoba, 1st, 42, <br>
                                Jln Syed Putra, <br>
                                50460, Federal Territory of Kuala Lumpur
                            </li>
                            <li><strong>Website:</strong> <a
                                    href="https://www.mercy.org.my/">https://www.mercy.org.my/</a></li>
                            <br>
                            <li>
                                MERCY Malaysia is a non-profit organisation focusing on providing medical relief,
                                sustainable health related development and risk reduction activities for
                                vulnerable communities in both crisis and non-crisis situations.
                                As a non-profit organisation, MERCY Malaysia relies solely on funding and donations
                                from organisations and generous individuals to continue their services to
                                provide humanitarian assistance to beneficiaries, both in Malaysia and internationally.
                                The organisation is a registered society according to the Societies Act 1966 in
                                Malaysia,
                                and the headquarters is in the capital city of Kuala Lumpur.
                                <br>
                                <small>From the <a href="https://www.mercy.org.my/about-us/our-history/"
                                        target="blank">MERCY Malaysia website</a></small>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <section class="row justify-content-center">
                    ...
                    <div class="col col-lg-8  list-of-reps">
                        <table id="representatives" class="table sortable-table" data-table-for="Representative">
                            ...
                            <tbody>
                                <tr>
                                    <td><a href="../users/syed.hisam001.php">H'ng Cho Chew</a></td>
