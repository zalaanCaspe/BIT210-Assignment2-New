                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-lg-6 ps-5">
                                <ul class="list-group profile-info">
                                    <li class="list-group-item">
                                        ...
                                        <a href="../kementerian-kesihatan-malaysia.php">
                                            Kementerian Kesihatan Malaysia
                                        </a>
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Username</strong>: syed.jahari0749
                                    </li>
                                    <li class="list-group-item">
                                        <strong>ID No</strong>: 000424-09-0749
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Email</strong>: <a href="mailto:syed.jahari@gmail.com">syed.jahari@gmail.com</a>
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Mobile No</strong>: <a href="tel:0183456729">0183456729</a>
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Household Income</strong>: RM1200
                                    </li>
                                    <li class="list-group-item">
                                        <strong>Address</strong>: <br>
                                        Block S-00-009, <br>
                                        Subang Perdana Good Year Court 2, <br>
                            ...
                            <div class="col col-lg-6 text-center">
                                <h5>Documents</h5>
                                <div class="profile-info sortable-table">
                                    <table class="table">
                                        ...
                                        <tbody id="docs-table-body">
                                            <tr>
                                                <td><a href="documents/syed.jahari0749-001.pdf">syed-jahari-ic.pdf</a></td>
                                                <td>Scanned IC PDF file</td>
                                            </tr>
                                            <tr>
                                                <td><a href="documents/syed.jahari0749-001.pdf">syed-jahari-proof-of-residence.pdf</a></td>
                                                <td>Proof of Residence</td>
                                            </tr>
                                            <tr>
                                                <td><a href="documents/syed.jahari0749-001.pdf">syed-jahari-marriage-certificate.pdf</a></td>
                                                <td>Marriage certificate</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="add-docs">
                                        <a onclick="clickAdd()">Add Documents</a>
                                        <input type="file" id="add-docs" onchange="addDocs(this.value)">
                                    </div>
                                </div>

                                <h5 class="pt-5">Disbursements</h5>
                                <div class="profile-info">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>01/01/2022</td>
                                                <td>-</td>
                                                <td>5 rice bags, 2 Milo packets</td>
                                            </tr>
                                            <tr>
                                                <td>15/02/2022</td>
                                                <td>RM1000</td>
                                    ...
                                    <a href="../disbursement.php" class="btn btn-primary">Disburse Aid</a>
                                </div>
                            </div>
                        </div>
                    </div>
